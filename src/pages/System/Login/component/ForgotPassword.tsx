...
export default (props: any) => {
  ...
  //
  // useEffect(() => {
  //   // console.log('state', props.isSwitched);
  //   setState({ ...props });
  //   // const isSwitched = props.isSwitched;
  // }, [props]);

  return (
    <div>
      <div
        className={classes_module(styles, 'container', 'a-container', props.isSwitched && 'is-txl')}
        id="a-container"
      >
        <div className={classes_module(styles, 'form')} id="a-form">
          <h2 className={classes_module(styles, 'form_title', 'title')}>找回密码</h2>
          ...
          <span className={classes_module(styles, 'form__span')}>根据身份证号码可以重新设置自己的密码</span>
          <ProForm
            submitter={{
