...
export default (props: any) => {
  ...
  return (
    <div>
      <div
        className={classes_module(styles, 'container', 'b-container', props.isSwitched && 'is-txl is-z200')}
        id="b-container"
      >
        <div className={classes_module(styles, 'form')} id="b-form">
          <h2 className={classes_module(styles, 'form_title', 'title')}>建业管理平台</h2>
          <div className={classes_module(styles, 'form__icons')}>
            <img
              className={classes_module(styles, 'form__icon')}
          ...
          <span className={classes_module(styles, 'form__span')}>致力于更好的服务您的企业</span>
          <ProForm
            ...
            submitter={{
              ...
              submitButtonProps: {
                className: classes_module(styles, 'form__button', 'button', 'submit', 'linearGradientButton'),
              },
            }}
          >
            <ProFormText
              ...
              fieldProps={{
                className: classes_module(styles, 'custom-pro-form-text'),
              }}
            />
